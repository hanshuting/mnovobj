function [] = plot_mikki_box_pair(data,cc1,cc2,p)
...
plot([ones(size(data{1,1}))-stepsz;ones(size(data{1,1}))+stepsz],...
    [data{1,1};data{1,2}],'color',min(cc1+0.7*[1 1 1],1));
plot([2*ones(size(data{2,1}))-stepsz;2*ones(size(data{2,1}))+stepsz],...
    [data{2,1};data{2,2}],'color',min(cc2+0.5*[1 1 1],1));
